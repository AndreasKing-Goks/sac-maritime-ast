...
class NNPolicy(Policy, Serializable):
    ...
    def get_action(self, observation):
        """
        Sample a single action based on the observations.
        """
    ...
    def get_params_internal(self, **tags):
        ...
        # Add "/" to 'scope' unless it's empty (otherwise get_collection will return all parameters that start with 'scope').
